...
TEST_PATH=tests-results-plan-nurticional
mkdir -p $TEST_PATH
...
pwd
pip install -r gestor_plan_nutricional/requirements.txt
echo "<================== [Fin][Exitoso] instalacion dependencias ==================>"
echo "<================== [Inicio] Ejecucion test ==================>"
pwd
cd /workspace/gestor_plan_nutricional
pwd
git pull
git checkout feature_gestor_plan_nutricional
git pull
