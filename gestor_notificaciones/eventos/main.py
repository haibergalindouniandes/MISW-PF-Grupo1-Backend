...
def registrar_notificacion_bd(data_dict):
    ...
    try:
        with db.connect() as conn:
            query = 'insert into notificaciones (id, usuario, descripcion, tipo, fecha_creacion, fecha_actualizacion) values (:id, :usuario, :descripcion, :tipo, :fecha_creacion, :fecha_actualizacion)'
